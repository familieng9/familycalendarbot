...
MEAL_PLANS = {
    ...
    7: {
        ...
        "Wed": {
            "lunch":      "Chicken soboro bento bowl (minced chicken, egg & peas on rice)",
            "lunch_url":  "https://www.justonecookbook.com/soboro-bento/",
...
GROCERY_LISTS = {
    ...
    4: {
        ...
        "🥩 Meat / Seafood": [
            "Prawns x350g peeled  (Mon tempura don, Tue soba, Thu udon, Fri chirashi)",
        ...
        "🛒 Pantry": [
            ...
            "Panko breadcrumbs x1 bag",
            "Tempura batter mix x1 bag  (Mon prawn tempura don)",
            "Nori sheets x1 pack",
            "Rice crackers x2 packs", "Graham crackers x1 box",
            "Sushi rice vinegar",
    ...
    7: {
        ...
        "🥩 Meat / Seafood": [
            ...
            "Chicken mince x200g  (Wed soboro bento bowl)",
        ],
        "🧊 Chilled": [
            "Eggs x8  (Tue tamagoyaki snack, Wed soboro, Thu hambagu)",
        ...
        "🛒 Pantry": [
            ...
            "Frozen peas x1 bag  (Wed soboro bento bowl)",
            "Miso paste x1 tub",
            "Soy sauce, mirin, sesame oil  (replenish if low)",
            "Dashi stock granules",
